Please check if what you want to add to `go-forest` list meets [quality standards](https://github.com/greenchainearth/go-forest/blob/master/CONTRIBUTING.md#quality-standard) before sending pull request.
