...
var (
	walletCommand = cli.Command{
		...
		Description: `
    forest wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	forest wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    forest account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    forest account import [options] <keyfile>
