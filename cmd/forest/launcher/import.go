...
import (
	...
	"github.com/greenchainearth/go-forest/utils/iodb"
	"github.com/greenchainearth/go-forest/utils/ioread"
)
...
func importEvents(ctx *cli.Context) error {
	...
	cfg := makeAllConfigs(ctx)
	cfg.Forest.Protocol.EventsSemaphoreLimit.Size = math.MaxUint32
	cfg.Forest.Protocol.EventsSemaphoreLimit.Num = math.MaxUint32
	cfg.Forest.Emitter.Validator = emitter.ValidatorConfig{}
	cfg.Forest.TxPool.Journal = ""
	cfg.Node.IPCPath = ""
	cfg.Node.HTTPHost = ""
	cfg.Node.WSHost = ""
	cfg.Node.NoUSB = true
