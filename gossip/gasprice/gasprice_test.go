...
func (t TestBackend) GetRules() forest.Rules {
	return t.rules
}

func (t TestBackend) GetPendingRules() forest.Rules {
...
func TestSuggestPrice(t *testing.T) {
	backend := &TestBackend{
		block:             1,
		totalGasPowerLeft: 0,
		rules:             forest.FakeNetRules(),
		pendingRules:      forest.FakeNetRules(),
	}
