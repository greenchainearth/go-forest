...
import (
	...
	"github.com/greenchainearth/seed-base/gossip/dagprocessor"
	"github.com/greenchainearth/seed-base/gossip/dagstream"
	"github.com/greenchainearth/seed-base/gossip/dagstream/streamleecher"
	"github.com/greenchainearth/seed-base/gossip/dagstream/streamseeder"
	"github.com/greenchainearth/seed-base/gossip/itemsfetcher"
	...
	"github.com/greenchainearth/go-forest/eventcheck/parentlesscheck"
...
// newHandler returns a new GreenChain sub protocol manager. The GreenChain sub protocol manages peers capable
// with the GreenChain network.
func newHandler(
	c handlerConfig,
) (
	*ProtocolManager,
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping GreenChain protocol")
	...
	log.Info("GreenChain protocol stopped")
}
