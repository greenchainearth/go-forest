...
func (s *Store) ApplyGenesis(blockProc BlockProc, g forest.Genesis) (genesisHash hash.Hash, err error) {
...
func (s *Store) applyEpoch0Genesis(g forest.Genesis) (evmBlock *evmcore.EvmBlock, err error) {
...
func (s *Store) applyEpoch1Genesis(blockProc BlockProc, g forest.Genesis) (err error) {
	...
	prettyHash := func(root common.Hash, g forest.Genesis) hash.Event {
