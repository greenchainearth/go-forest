...
import (
	...
	"github.com/greenchainearth/go-forest/ethapi"
	"github.com/greenchainearth/go-forest/eventcheck"
	...
	"github.com/greenchainearth/go-forest/gossip/blockproc"
	"github.com/greenchainearth/go-forest/gossip/blockproc/drivermodule"
	"github.com/greenchainearth/go-forest/gossip/blockproc/eventmodule"
	"github.com/greenchainearth/go-forest/gossip/blockproc/evmmodule"
	"github.com/greenchainearth/go-forest/gossip/blockproc/sealmodule"
	"github.com/greenchainearth/go-forest/gossip/blockproc/verwatcher"
	"github.com/greenchainearth/go-forest/gossip/emitter"
	"github.com/greenchainearth/go-forest/gossip/filters"
	...
	"github.com/greenchainearth/go-forest/utils/gsignercache"
	"github.com/greenchainearth/go-forest/utils/wgmutex"
	"github.com/greenchainearth/go-forest/valkeystore"
...
func DefaultBlockProc(g forest.Genesis) BlockProc {
	return BlockProc{
...
func NewService(stack *node.Node, config Config, store *Store, signer valkeystore.SignerI, blockProc BlockProc, engine seed.Consensus, dagIndexer *vecmt.Index) (*Service, error) {
...
func newService(config Config, store *Store, signer valkeystore.SignerI, blockProc BlockProc, engine seed.Consensus, dagIndexer *vecmt.Index) (*Service, error) {
	svc := &Service{
		config:             config,
...
// MakeProtocols constructs the P2P protocol definitions for `forest`.
...
func (s *Service) Stop() error {
	defer log.Info("GreenChain service stopped")
	s.verWatcher.Stop()
	close(s.done)
	s.emitter.Stop()
	s.pm.Stop()
