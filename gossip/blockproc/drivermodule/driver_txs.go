...
import (
	...
	"github.com/greenchainearth/go-forest/forest/genesis/driver/drivercall"
	"github.com/greenchainearth/go-forest/forest/genesis/driver/driverpos"
	...
	netinitcall "github.com/greenchainearth/go-forest/forest/genesis/netinit/netinitcalls"
	...
	"github.com/greenchainearth/go-forest/inter/drivertype"
	"github.com/greenchainearth/go-forest/inter/validatorpk"
)
...
func NewDriverTxGenesisTransactor(g forest.Genesis) *DriverTxGenesisTransactor {
...
func (p *DriverTxListener) OnNewLog(l *types.Log) {
	...
	if l.Topics[0] == driverpos.Topics.UpdateNetworkRules && len(l.Data) >= 64 {
		...
		p.bs.DirtyRules, err = forest.UpdateRules(p.bs.DirtyRules, diff)
		if err != nil {
