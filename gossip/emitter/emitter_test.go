...
import (
	...
	"github.com/greenchainearth/go-forest/gossip/emitter/mock"
...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/greenchainearth/go-forest/gossip/emitter External,TxPool,TxSigner,Signer
