...
import (
	...
	"github.com/greenchainearth/go-forest/topicsdb"
	"github.com/greenchainearth/go-forest/tracing"
)
...
// GetEventPayload returns Seed event by hash or short ID.
...
// GetEvent returns the Seed event header by hash or short ID.
...
func (b *EthAPIBackend) GetEVM(ctx context.Context, msg evmcore.Message, state *state.StateDB, header *evmcore.EvmHeader, vmConfig *vm.Config) (*vm.EVM, func() error, error) {
	...
	if vmConfig == nil {
		vmConfig = &forest.DefaultVMConfig
	}
