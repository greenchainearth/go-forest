...
* cmd: Enable reading config from file (seed.toml, .json, or .yaml)

IMPROVEMENTS:

* node: major refactoring of configuration and initialization of Seed node.
...
instead. 
* docs: Added sections on Seed and FastSync.