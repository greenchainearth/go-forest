...
import (
	...
	base "github.com/greenchainearth/seed-base/eventcheck/epochcheck"
...
type Reader interface {
	base.Reader
	GetEpochRules() (forest.Rules, idx.Epoch)
}
...
func CalcGasPowerUsed(e inter.EventPayloadI, rules forest.Rules) uint64 {
	txsGas := uint64(0)
...
func (v *Checker) checkGas(e inter.EventPayloadI, rules forest.Rules) error {
...
func CheckTxs(txs types.Transactions, rules forest.Rules) error {
	maxType := uint8(0)
